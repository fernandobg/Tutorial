...
<div class="wrapper row1">
  <header id="header" class="clear"> 
    ...
    <div id="logo" class="fl_left">
      <h1><a href="index.html">SISTEMA GESTION ACADEMICA SAGCA</a></h1>
      <p>Autor: </p>
    </div>
    <div class="fl_right">
  ...
  <div class="rounded">
    <main class="container clear"> 
      ...
      <div class="group btmspace-30"> 
		...
		<iframe src="http://localhost:8082/Gestion_Academica/f_registro_alumnos.jsp" width=900 height="700" frameborder= 0></iframe>
          <!-- ################################################################################################ --> 
        </div>
        <!-- / Middle Column --> 
