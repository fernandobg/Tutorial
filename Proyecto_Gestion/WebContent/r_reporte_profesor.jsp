...
private static final String report_path = "c:\\reportes\\rpt_Profesores.jrxml"; 
private static final String export_path = "c:\\reportes\\rpt_Profesores.pdf"; 
...
%>
<body>
<form name="frmReporte4" method="post" action="">
<center>
