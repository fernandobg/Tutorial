...
<html>
<head>
<title>GESTION ACADEMICA SAGCA</title>
<meta charset="utf-8">
...
<div class="wrapper row1">
  <header id="header" class="clear"> 
    ...
    <div id="logo" class="fl_left">
      <h1><a href="index.html">GESTION ACADEMICA SAGCA</a></h1>
...
<div class="wrapper">
  <div id="slider">
    <div id="slide-wrapper" class="rounded clear" width="900"> 
      <!-- ################################################################################################ -->
      <figure id="slide-1"><a class="view" href="#"><img src="images/demo/slider/1.png" alt=""></a>
        <figcaption>
     
        <center> <iframe src="form_login.jsp"></iframe></center>
